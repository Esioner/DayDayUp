...
public class RecommendFragment extends Fragment {
    ...
    public static boolean RECOMMEND_IS_OK = false;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
            Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nei_han_recommend_fragment, container, false);
        smartRefreshLayout = (SmartRefreshLayout) view.findViewById(R.id.smart_refresh_layout_recommend);
...
//        loadJokeData();
    ...
    private void showText(List<NeiHanDataBean> list) {
        if (mAdapter == null) {
            ...
            isFirst = false;
            EventBus.getDefault().post(new MessageEvent(NeiHanFragment.RECOMMEND_TASK,true));
